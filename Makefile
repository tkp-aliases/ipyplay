...
lint-py:  ## lint python with ruff
	python -m ruff check ipyplay
	python -m ruff format --check ipyplay
...
fix-py:  ## autoformat python code with ruff
	python -m ruff check --fix ipyplay
	python -m ruff format ipyplay
...
test:  ## run python tests
	python -m pytest -v ipyplay/tests

coverage:  ## run tests and collect test coverage
	python -m pytest -v ipyplay/tests --cov=ipyplay --cov-report term-missing --cov-report xml
